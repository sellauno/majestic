            ...
            <table class="table align-items-center mb-0">
              <thead>
                <tr>
                  ...
                  <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">To Do List</th>
                ...
                <tr>
                  <td>
                    <div class="d-flex px-2 py-1">
                      <div>
                        <img src="{{asset('btsr/assets/img/team-2.jp')}}g" class="avatar avatar-sm me-3" alt="user1">
                      </div>
