                            ...
                            <div class="d-flex flex-column">
                                ...
                                <form enctype="multipart/form-data" action="{{route('addFile')}}" method="POST">
                                    ...
                                    <div class="form-check">
                                        ...
                                        <label class="font-weight-bold custom-control-label <?php if ($checklist->deadline < now()) echo 'text-danger';
                                                                                            else echo 'text-dark '; ?>" for="customCheck1"> {{$checklist->toDO}} </label><br>
                                        <span class="text-xs"> Deadline : {{$checklist->deadline}}</span>
                                        &nbsp;
